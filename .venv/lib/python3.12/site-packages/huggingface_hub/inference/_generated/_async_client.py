...
class AsyncInferenceClient:
    ...
    async def _get_async_client(self):
        ...
        if self._async_client is None:
            self._async_client = await self.exit_stack.enter_async_context(
                get_async_session()
            )
    ...
    async def automatic_speech_recognition(
        ...
        *,
        ...
        response = await self._inner_post(request_parameters)
        response = provider_helper.get_response(
            response, request_params=request_parameters
        )
    ...
    async def image_to_text(
        self, image: ContentT, *, model: str | None = None
    ) -> ImageToTextOutput:
        """
        ...
        response = await self._inner_post(request_parameters)
        output_list: list[ImageToTextOutput] = ImageToTextOutput.parse_obj_as_list(
            response
        )
    ...
    async def tabular_classification(
        self, table: dict[str, Any], *, model: str | None = None
    ) -> list[str]:
        """
    ...
    async def text_generation(
        ...
        *,
        ...
        typical_p: float | None = None,
        watermark: bool | None = None,
    ) -> str | TextGenerationOutput | AsyncIterable[str] | AsyncIterable[
        TextGenerationStreamOutput
    ]:
        ...
