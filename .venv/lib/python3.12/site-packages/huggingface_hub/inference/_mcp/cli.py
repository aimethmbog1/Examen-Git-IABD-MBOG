    ...
    try:
        ...
        if len(inputs) > 0:
            ...
            for input_item in inputs:
                ...
                print(
                    ANSI.blue(f" • {input_id}")
                    + f": {description}. (default: load from {env_variable_key}).",
                    end=" ",
                )
                ...
                if not final_value:
                    ...
                    if final_value:
                        print(
                            ANSI.green(
                                f"Value successfully loaded from '{env_variable_key}'"
                            )
                        )
                    else:
                        print(
        ...
        async with Agent(
            ...
            print(
                ANSI.bold(
                    ANSI.blue(
                        "Agent loaded with {} tools:".format(len(agent.available_tools))
                    )
                )
            )
            ...
            while True:
                ...
                try:
                    ...
                    if not first_sigint and abort_event.is_set():
                        ...
                        print(
                            ANSI.red("\nKeyboard interrupt during input processing."),
                            flush=True,
                        )
                        break
