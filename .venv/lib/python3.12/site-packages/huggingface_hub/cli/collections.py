...
def collections_info(
    collection_slug: Annotated[
        str,
        typer.Argument(help="The collection slug (e.g., 'username/collection-slug')."),
    ],
    token: TokenOpt = None,
) -> None:
...
def collections_create(
    ...
    namespace: Annotated[
        str | None,
        typer.Option(
            help="The namespace (username or organization). Defaults to the authenticated user."
        ),
    ] = None,
...
def collections_update(
    ...
    theme: Annotated[
        str | None,
        typer.Option(
            help="The theme color for the collection (e.g., 'green', 'blue')."
        ),
    ] = None,
    token: TokenOpt = None,
) -> None:
...
def collections_add_item(
    ...
    item_id: Annotated[
        str,
        typer.Argument(
            help="The ID of the item to add (repo_id for repos, paper ID for papers)."
        ),
    ],
    item_type: Annotated[
        CollectionItemType,
        typer.Argument(
            help="The type of item (model, dataset, space, paper, collection, or bucket)."
        ),
    ],
    note: Annotated[
        str | None,
    ...
    exists_ok: Annotated[
        bool,
        typer.Option(
            help="Do not raise an error if the item is already in the collection."
        ),
    ] = False,
    token: TokenOpt = None,
) -> None:
...
def collections_update_item(
    ...
    item_object_id: Annotated[
        str,
        typer.Argument(
            help="The ID of the item in the collection (from 'item_object_id' field, not the repo_id)."
        ),
    ],
    note: Annotated[
        str | None,
