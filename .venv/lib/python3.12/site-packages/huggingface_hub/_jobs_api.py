...
class JobDurations:
    ...
    def __init__(self, **kwargs) -> None:
        self.scheduling_secs = kwargs.get(
            "schedulingSecs", kwargs.get("scheduling_secs")
        )
...
class JobInfo:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.initiator = (
            JobInitiator(
                type=initiator["type"], id=initiator["id"], name=initiator.get("name")
            )
            if initiator
            else None
        )
...
class ScheduledJobStatus:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.next_job_run_at = (
            parse_datetime(str(next_job_run_at)) if next_job_run_at else None
        )
