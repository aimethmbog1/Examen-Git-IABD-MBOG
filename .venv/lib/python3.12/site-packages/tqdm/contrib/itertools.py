...
def product(*iterables, repeat=1, total=None, tqdm_class=tqdm_auto, **kwargs):
    ...
    if total is None:
        try:
            ...
            total **= repeat
    for i in tqdm_class(
        itertools.product(*iterables, repeat=repeat), total=total, **kwargs
    ):
        yield i
...
def combinations_with_replacement(
    iterable, r, total=None, tqdm_class=tqdm_auto, **kwargs
):
    ...
    if total is None:
        try:
            ...
            for i in range(1, r + 1):
                total //= i
    return tqdm_class(
        itertools.combinations_with_replacement(iterable, r), total=total, **kwargs
    )
