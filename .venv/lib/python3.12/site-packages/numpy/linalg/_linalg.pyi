...
def svdvals(  # type: ignore[overload-overlap]
    x: _ArrayLike[np.float64 | np.complex128 | np.integer | np.bool]
...
) -> tuple[NDArray[floating], NDArray[floating], int32, NDArray[floating],]: ...
@overload
def lstsq(
    a: _ArrayLikeComplex_co, b: _ArrayLikeComplex_co, rcond: float | None = None
) -> tuple[NDArray[complexfloating], NDArray[floating], int32, NDArray[floating],]: ...
@overload
def norm(
    x: ArrayLike,
