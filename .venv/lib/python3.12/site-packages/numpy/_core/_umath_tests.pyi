...
always_error_gufunc: Final[
    _GUFunc_Nin2_Nout1[L["always_error_gufunc"], L[1], None, L["(i),()->()"]]
] = ...
...
matrix_multiply: Final[
    _GUFunc_Nin2_Nout1[L["matrix_multiply"], L[3], None, L["(m,n),(n,p)->(m,p)"]]
] = ...
matmul: Final[
    _GUFunc_Nin2_Nout1[L["matmul"], L[3], None, L["(m?,n),(n,p?)->(m?,p?)"]]
] = ...
euclidean_pdist: Final[
    _GUFunc_Nin2_Nout1[L["euclidean_pdist"], L[2], None, L["(n,d)->(p)"]]
] = ...
cumsum: Final[np.ufunc] = ...  # we have no specialized type for 1->1 gufuncs
inner1d_no_doc: Final[
    _GUFunc_Nin2_Nout1[L["inner1d_no_doc"], L[2], None, L["(i),(i)->()"]]
] = ...
cross1d: Final[_GUFunc_Nin2_Nout1[L["cross1d"], L[2], None, L["(3),(3)->(3)"]]] = ...
_pickleable_module_global_ufunc: Final[
    np.ufunc
] = ...  # 0->0 ufunc; segfaults if called
indexed_negative: Final[
    _UFunc_Nin1_Nout1[L["indexed_negative"], L[0], L[0]]
] = ...  # ntypes=0; can't be called
conv1d_full: Final[
    _GUFunc_Nin2_Nout1[L["conv1d_full"], L[1], None, L["(m),(n)->(p)"]]
] = ...
