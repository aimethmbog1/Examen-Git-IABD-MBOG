...
) -> tuple[_MArray[_ScalarT1], _MArray[_ScalarT2]]: ...
@overload
def atleast_1d(
...
) -> tuple[_MArray[Incomplete], _MArray[Incomplete]]: ...
@overload
def atleast_1d(
    a0: ArrayLike, a1: ArrayLike, /, *ai: ArrayLike
) -> tuple[_MArray[Incomplete], ...]: ...
...
@overload
def hsplit(
    ary: _ArrayLike[_ScalarT], indices_or_sections: _ShapeLike
) -> list[_MArray[_ScalarT]]: ...
@overload
def hsplit(
    ary: ArrayLike, indices_or_sections: _ShapeLike
) -> list[_MArray[Incomplete]]: ...
...
) -> MaskedArray[Incomplete, np.dtype[Incomplete]]: ...
