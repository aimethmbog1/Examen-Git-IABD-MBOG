...
@type_check_only
def func(
    a: np.ndarray, posarg: bool = ..., /, arg: int = ..., *, kwarg: str = ...
) -> np.ndarray: ...
@type_check_only
...
assert_type(
    np.average(AR_f8_2d, keepdims=True),
...
assert_type(
    np.average(AR_f8, axis=1, returned=True),
    tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]],
)
assert_type(
    np.average(AR_f8, keepdims=True, returned=True),
    tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]],
)
...
assert_type(
    np.average(AR_LIKE_f8, axis=1, returned=True),
    tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]],
)
assert_type(
    np.average(AR_LIKE_f8, keepdims=True, returned=True),
    tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]],
)
...
assert_type(
    np.average(AR_O, keepdims=True, returned=True), tuple[np.ndarray, np.ndarray]
)

# asarray_chkfinite
assert_type(
    np.asarray_chkfinite(AR_f8_1d), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
# piecewise
assert_type(
    np.piecewise(AR_f8_1d, AR_b, [func]), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
assert_type(
    np.piecewise(AR_f8, AR_b_list, [func], True, -1, kwarg=""), npt.NDArray[np.float64]
)
assert_type(
    np.piecewise(AR_f8, AR_b_list, [func], True, arg=-1, kwarg=""),
...
assert_type(
    np.extract(AR_i8, AR_LIKE_c16), np.ndarray[tuple[int], np.dtype[np.complex128]]
)
...
assert_type(
    np.copy(CHAR_AR_U, "K", subok=True),
    np.char.chararray[tuple[Any, ...], np.dtype[np.str_]],
)
assert_type(
    np.copy(CHAR_AR_U, subok=True),
    np.char.chararray[tuple[Any, ...], np.dtype[np.str_]],
)
# pyright correctly infers `NDArray[str_]` here
assert_type(
    np.copy(CHAR_AR_U), np.ndarray[Any, Any]
...
assert_type(
    np.gradient(AR_LIKE_f8, edge_order=2), np.ndarray[tuple[int], np.dtype[np.float64]]
)
assert_type(
    np.gradient(AR_LIKE_c16, axis=0), np.ndarray[tuple[int], np.dtype[np.complex128]]
)
...
assert_type(
    np.diff(AR_f8_2d, axis=0), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(
    np.diff(AR_LIKE_f8, prepend=1.5), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
assert_type(
    np.interp([1], [1], AR_c16), np.ndarray[tuple[int], np.dtype[np.complex128]]
)
...
assert_type(
    np.cov(AR_c16, AR_c16), np.ndarray[tuple[int, int], np.dtype[np.complex128]]
)
assert_type(np.cov(AR_LIKE_f8), np.ndarray[tuple[()], np.dtype[np.float64]])
assert_type(
    np.cov(AR_LIKE_f8, AR_LIKE_f8), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(
    np.cov(AR_LIKE_f8, dtype=np.float16), np.ndarray[tuple[()], np.dtype[np.float16]]
)
assert_type(
    np.cov(AR_LIKE_f8, AR_LIKE_f8, dtype=np.float32),
...
assert_type(
    np.corrcoef(AR_f8_2d),
    np.ndarray[tuple[int, int], np.dtype[np.float64]] | np.float64,
)
assert_type(
    np.corrcoef(AR_f8), np.ndarray[tuple[int, int], np.dtype[np.float64]] | np.float64
)
assert_type(
    np.corrcoef(AR_f8, AR_f8), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(
    np.corrcoef(AR_c16, AR_c16), np.ndarray[tuple[int, int], np.dtype[np.complex128]]
)
assert_type(np.corrcoef(AR_LIKE_f8), np.float64)
assert_type(
    np.corrcoef(AR_LIKE_f8, AR_LIKE_f8),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
assert_type(np.corrcoef(AR_LIKE_f8, dtype=np.float16), np.float16)
assert_type(
    np.corrcoef(AR_LIKE_f8, AR_LIKE_f8, dtype=np.float32),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    np.corrcoef(AR_LIKE_f8, AR_LIKE_f8, dtype=float), np.ndarray[tuple[int, int]]
)
...
assert_type(
    ...
    tuple[np.ndarray[tuple[int], np.dtype[np.complex128]],],
)
assert_type(
...
assert_type(
    np.meshgrid(AR_f8, AR_f8, AR_f8, AR_f8), tuple[npt.NDArray[np.float64], ...]
)
...
# insert
assert_type(
    np.insert(AR_f8, np.s_[:5], 5), np.ndarray[tuple[int], np.dtype[np.float64]]
)
