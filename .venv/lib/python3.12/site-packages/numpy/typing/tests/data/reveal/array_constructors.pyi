...
assert_type(
    np.arange(_x_timedelta), np.ndarray[tuple[int], np.dtype[np.timedelta64[Any]]]
)
assert_type(
    np.arange(0, _x_timedelta), np.ndarray[tuple[int], np.dtype[np.timedelta64[Any]]]
)
assert_type(
    np.arange(_x_datetime, _x_datetime),
    np.ndarray[tuple[int], np.dtype[np.datetime64[Any]]],
)
assert_type(
...
assert_type(
    np.arange("2025-12-20", "2025-12-23", dtype="datetime64[D]"),
    np.ndarray[tuple[int], np.dtype[np.datetime64[Any]]],
)
...
assert_type(
    np.identity(3, dtype=np.int8), np.ndarray[tuple[int, int], np.dtype[np.int8]]
)
assert_type(np.identity(3, dtype=bool), np.ndarray[tuple[int, int], np.dtype[np.bool]])
assert_type(
    np.identity(3, dtype="bool"), np.ndarray[tuple[int, int], np.dtype[np.bool]]
)
...
assert_type(
    np.identity(3, dtype=int), np.ndarray[tuple[int, int], np.dtype[np.int_ | Any]]
)
assert_type(
    np.identity(3, dtype="int"), np.ndarray[tuple[int, int], np.dtype[np.int_ | Any]]
)
assert_type(
    np.identity(3, dtype="n"), np.ndarray[tuple[int, int], np.dtype[np.int_ | Any]]
)
assert_type(
    np.identity(3, dtype=float), np.ndarray[tuple[int, int], np.dtype[np.float64 | Any]]
)
assert_type(
...
assert_type(
    np.identity(3, dtype="f8"), np.ndarray[tuple[int, int], np.dtype[np.float64 | Any]]
)
assert_type(
    np.identity(3, dtype="d"), np.ndarray[tuple[int, int], np.dtype[np.float64 | Any]]
)
assert_type(
...
assert_type(
    np.identity(3, dtype="c16"),
    np.ndarray[tuple[int, int], np.dtype[np.complex128 | Any]],
)
assert_type(
    np.identity(3, dtype="D"),
    np.ndarray[tuple[int, int], np.dtype[np.complex128 | Any]],
)
