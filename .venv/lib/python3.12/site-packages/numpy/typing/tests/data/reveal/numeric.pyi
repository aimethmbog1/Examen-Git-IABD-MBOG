...
assert_type(
    np.correlate(AR_f8, AR_i8), np.ndarray[tuple[int], np.dtype[np.float64 | Any]]
)
assert_type(
    np.correlate(AR_c16, AR_c16), np.ndarray[tuple[int], np.dtype[np.complex128]]
)
assert_type(
    np.correlate(AR_c16, AR_f8), np.ndarray[tuple[int], np.dtype[np.complex128 | Any]]
)
assert_type(np.correlate(AR_m, AR_m), np.ndarray[tuple[int], np.dtype[np.timedelta64]])
assert_type(
    np.correlate(AR_i8, AR_m), np.ndarray[tuple[int], np.dtype[np.timedelta64 | Any]]
)
assert_type(np.correlate(AR_O, AR_O), np.ndarray[tuple[int], np.dtype[np.object_]])
assert_type(
    np.correlate(_to_1d_bool, _to_1d_bool), np.ndarray[tuple[int], np.dtype[np.bool]]
)
assert_type(
    np.correlate(_to_1d_int, _to_1d_int),
    np.ndarray[tuple[int], np.dtype[np.int_ | Any]],
)
assert_type(
    np.correlate(_to_1d_float, _to_1d_float),
    np.ndarray[tuple[int], np.dtype[np.float64 | Any]],
)
assert_type(
    np.correlate(_to_1d_complex, _to_1d_complex),
    np.ndarray[tuple[int], np.dtype[np.complex128 | Any]],
)
...
assert_type(
    np.convolve(AR_f8, AR_i8), np.ndarray[tuple[int], np.dtype[np.float64 | Any]]
)
assert_type(
    np.convolve(AR_c16, AR_c16), np.ndarray[tuple[int], np.dtype[np.complex128]]
)
assert_type(
    np.convolve(AR_c16, AR_f8), np.ndarray[tuple[int], np.dtype[np.complex128 | Any]]
)
assert_type(np.convolve(AR_m, AR_m), np.ndarray[tuple[int], np.dtype[np.timedelta64]])
assert_type(
    np.convolve(AR_i8, AR_m), np.ndarray[tuple[int], np.dtype[np.timedelta64 | Any]]
)
assert_type(np.convolve(AR_O, AR_O), np.ndarray[tuple[int], np.dtype[np.object_]])
assert_type(
    np.convolve(_to_1d_bool, _to_1d_bool), np.ndarray[tuple[int], np.dtype[np.bool]]
)
assert_type(
    np.convolve(_to_1d_int, _to_1d_int), np.ndarray[tuple[int], np.dtype[np.int_ | Any]]
)
assert_type(
    np.convolve(_to_1d_float, _to_1d_float),
    np.ndarray[tuple[int], np.dtype[np.float64 | Any]],
)
assert_type(
    np.convolve(_to_1d_complex, _to_1d_complex),
    np.ndarray[tuple[int], np.dtype[np.complex128 | Any]],
)
...
assert_type(
    np.outer(AR_f8, AR_i8), np.ndarray[tuple[int, int], np.dtype[np.float64 | Any]]
)
assert_type(
    np.outer(AR_c16, AR_c16), np.ndarray[tuple[int, int], np.dtype[np.complex128]]
)
assert_type(
    np.outer(AR_c16, AR_f8), np.ndarray[tuple[int, int], np.dtype[np.complex128 | Any]]
)
assert_type(np.outer(AR_m, AR_m), np.ndarray[tuple[int, int], np.dtype[np.timedelta64]])
assert_type(
    np.outer(AR_i8, AR_m), np.ndarray[tuple[int, int], np.dtype[np.timedelta64 | Any]]
)
...
assert_type(
    np.outer(_to_1d_bool, _to_1d_bool), np.ndarray[tuple[int, int], np.dtype[np.bool]]
)
assert_type(
    np.outer(_to_1d_int, _to_1d_int),
    np.ndarray[tuple[int, int], np.dtype[np.int_ | Any]],
)
assert_type(
    np.outer(_to_1d_float, _to_1d_float),
    np.ndarray[tuple[int, int], np.dtype[np.float64 | Any]],
)
assert_type(
    np.outer(_to_1d_complex, _to_1d_complex),
    np.ndarray[tuple[int, int], np.dtype[np.complex128 | Any]],
)
...
assert_type(
    np.tensordot(_to_1d_complex, _to_1d_complex), npt.NDArray[np.complex128 | Any]
)
...
assert_type(
    np.isclose(_to_1d_int, _to_1d_int), np.ndarray[tuple[int], np.dtype[np.bool]]
)
