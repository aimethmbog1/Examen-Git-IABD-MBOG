...
class TestDataSourceAbspath:
    def test_ValidHTTP(self, tmp_path):
        ...
        local_path = os.path.join(tmp_path, netloc, upath.strip(os.sep).strip("/"))
    ...
    def test_InvalidHTTP(self, tmp_path):
        ...
        invalidhttp = os.path.join(tmp_path, netloc, upath.strip(os.sep).strip("/"))
...
class TestRepositoryAbspath:
    def test_ValidHTTP(self, tmp_path):
        ...
        local_path = os.path.join(
            repos._destpath, netloc, upath.strip(os.sep).strip("/")
        )
