...
@overload
def fftshift(
    x: _ArrayLike[_ScalarT], axes: _ShapeLike | None = None
) -> NDArray[_ScalarT]: ...
@overload
...
@overload
def fftfreq(
    n: int | integer, d: _ArrayLikeFloat_co = 1.0, device: L["cpu"] | None = None
) -> NDArray[floating]: ...
@overload
def fftfreq(
    n: int | integer, d: _ArrayLikeComplex_co = 1.0, device: L["cpu"] | None = None
