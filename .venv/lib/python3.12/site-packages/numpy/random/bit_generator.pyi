...
class _GenerateStateMixin(_CythonMixin):
    def generate_state(
        self, /, n_words: int, dtype: _DTypeLikeUint_ = ...
...
class BitGenerator(_CythonMixin, abc.ABC):
    ...
    #
    def __init__(
        self, /, seed: _ArrayLikeInt_co | SeedSequence | None = None
    ) -> None: ...
    def __reduce__(
        self,
    ) -> tuple[
        Callable[[str], Self], tuple[str], tuple[Mapping[str, Any], ISeedSequence]
    ]: ...
    def spawn(self, /, n_children: int) -> list[Self]: ...
    ...
    @overload
    def random_raw(
        self, /, size: _ShapeLike | None, output: Literal[False]
    ) -> None: ...
    @overload
    def random_raw(
