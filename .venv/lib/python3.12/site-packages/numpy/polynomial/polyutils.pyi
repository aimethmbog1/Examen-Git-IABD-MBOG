...
@overload
def as_series(
    alist: npt.NDArray[np.integer] | _FloatArray, trim: bool = True
) -> list[_FloatSeries]: ...
@overload
...
@overload
def as_series(
    alist: Iterable[_FloatArray | npt.NDArray[np.integer]], trim: bool = True
) -> list[_FloatSeries]: ...
@overload
def as_series(
    alist: Iterable[_ComplexArray], trim: bool = True
) -> list[_ComplexSeries]: ...
@overload
def as_series(
    alist: Iterable[_ObjectArray], trim: bool = True
) -> list[_ObjectSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeFloat_co | float], trim: bool = True
) -> list[_FloatSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeComplex_co | complex], trim: bool = True
) -> list[_ComplexSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeCoef_co | object], trim: bool = True
) -> list[_ObjectSeries]: ...
...
@overload
def trimcoef(
    c: npt.NDArray[np.integer] | _FloatArray, tol: _FloatLike_co = 0
) -> _FloatSeries: ...
@overload
...
@overload
def trimcoef(
    c: _SeriesLikeFloat_co | float, tol: _FloatLike_co = 0
) -> _FloatSeries: ...
@overload
def trimcoef(
    c: _SeriesLikeComplex_co | complex, tol: _FloatLike_co = 0
) -> _ComplexSeries: ...
@overload
def trimcoef(
    c: _SeriesLikeCoef_co | object, tol: _FloatLike_co = 0
) -> _ObjectSeries: ...
...
@overload
def mapparms(
    old: npt.NDArray[np.number], new: npt.NDArray[np.number]
) -> _Tuple2[np.complexfloating]: ...
@overload
def mapparms(
    old: npt.NDArray[np.object_ | np.number], new: npt.NDArray[np.object_ | np.number]
) -> _Tuple2[object]: ...
@overload
...
@overload
def mapparms(
    old: _SeriesLikeFloat_co, new: _SeriesLikeFloat_co
) -> _Tuple2[np.floating]: ...
@overload
def mapparms(
    old: _SeriesLikeComplex_co, new: _SeriesLikeComplex_co
) -> _Tuple2[np.complexfloating]: ...
@overload
...
@overload
def mapdomain(
    x: _FloatLike_co, old: _SeriesLikeFloat_co, new: _SeriesLikeFloat_co
) -> np.floating: ...
@overload
def mapdomain(
    x: _NumberLike_co, old: _SeriesLikeComplex_co, new: _SeriesLikeComplex_co
) -> np.complexfloating: ...
@overload
def mapdomain(
...
@overload
def mapdomain(
    x: npt.NDArray[np.number], old: npt.NDArray[np.number], new: npt.NDArray[np.number]
) -> _ComplexSeries: ...
@overload
def mapdomain(
...
@overload
def mapdomain(
    x: _SeriesLikeFloat_co, old: _SeriesLikeFloat_co, new: _SeriesLikeFloat_co
) -> _FloatSeries: ...
@overload
def mapdomain(
    x: _SeriesLikeComplex_co, old: _SeriesLikeComplex_co, new: _SeriesLikeComplex_co
) -> _ComplexSeries: ...
@overload
def mapdomain(
    x: _SeriesLikeCoef_co, old: _SeriesLikeCoef_co, new: _SeriesLikeCoef_co
) -> _ObjectSeries: ...
@overload
def mapdomain(
    x: _CoefLike_co, old: _SeriesLikeCoef_co, new: _SeriesLikeCoef_co
) -> object: ...
...
@overload
def _fromroots(
    line_f: _AnyLineF, mul_f: _AnyMulF, roots: _SeriesLikeFloat_co
) -> _FloatSeries: ...
@overload
def _fromroots(
    line_f: _AnyLineF, mul_f: _AnyMulF, roots: _SeriesLikeComplex_co
) -> _ComplexSeries: ...
@overload
def _fromroots(
    line_f: _AnyLineF, mul_f: _AnyMulF, roots: _SeriesLikeObject_co
) -> _ObjectSeries: ...
@overload
def _fromroots(
    line_f: _AnyLineF, mul_f: _AnyMulF, roots: _SeriesLikeCoef_co
) -> _CoefSeries: ...
...
@overload
def _div(
    mul_f: _AnyMulF, c1: _SeriesLikeFloat_co, c2: _SeriesLikeFloat_co
) -> _Tuple2[_FloatSeries]: ...
@overload
def _div(
    mul_f: _AnyMulF, c1: _SeriesLikeComplex_co, c2: _SeriesLikeComplex_co
...
@overload
def _div(
    mul_f: _AnyMulF, c1: _SeriesLikeCoef_co, c2: _SeriesLikeCoef_co
) -> _Tuple2[_CoefSeries]: ...
...
@overload
def _pow(
    mul_f: _AnyMulF, c: _SeriesLikeFloat_co, pow: _AnyInt, maxpower: _AnyInt | None
) -> _FloatSeries: ...
@overload
def _pow(
    mul_f: _AnyMulF, c: _SeriesLikeComplex_co, pow: _AnyInt, maxpower: _AnyInt | None
) -> _ComplexSeries: ...
@overload
def _pow(
    mul_f: _AnyMulF, c: _SeriesLikeObject_co, pow: _AnyInt, maxpower: _AnyInt | None
) -> _ObjectSeries: ...
@overload
def _pow(
    mul_f: _AnyMulF, c: _SeriesLikeCoef_co, pow: _AnyInt, maxpower: _AnyInt | None
) -> _CoefSeries: ...
