...
class PredictBody(BaseModel):
    ...
    batched: bool | None = False  # Whether the data is a batch of samples (i.e. called from the queue if batch=True) or a single sample (i.e. called from the UI)
...
class PredictBodyInternal(PredictBody):
    ...
    request: PydanticStarletteRequest | None = None  # dictionary of request headers, query parameters, url, etc. (used to to pass in request for queuing)
